...
public class ElementUtil {
	 ...
	 */
	public void doSerch(By searchlocator, By searchSuggutions, String searchkey, String value)
			throws InterruptedException {
	...
	// With Out used Existing method we are able to select the specific value from
	// drop down list
	...
	// select the value from drop down list and click on that ** WITH OUT SELECT
	// CLASS ***
...
//********************************Action Class Utility  ******************************************** //
	...
	public void handleMenuSubMenuLevelFour(By lelvelOneMenuLocator, By levelTwoMenuLocator, By levelThreeMenuLocator,
			By levelfourMenuLocator) throws InterruptedException {
...
// ****************************** Wait Utility ****************************************************
	 ...
	 * 
	 * @param locator
	 * @param timeOut default interval time = 500 milliseconds
	 * @return
	 */
	...
	/**
	 * //Wait till give total time with polling time / intervalTime sleep The
	 * duration in milliseconds to sleep between polls.
	 * 
	 * @param locator
	 * @param timeOut
	 * @param intervalTime
...
// ************************ wait Alert Utility *********************		
	...
	public WebElement retryingElement(By locator, int timeOut) {
		...
		if (element == null) {
			System.out.println("Element Is NOT Found Try For " + timeOut + " times " + " With Interval Time Of " + 500
					+ " MilliSeconds");
	...
	public WebElement retryingElement(By locator, int timeOut, int intervalTime) {
		...
		if (element == null) {
			System.out.println("Element Is NOT Found Try For " + timeOut + " times " + " With Interval Time Of "
